...
function FilterByCategory({ categories, handleFilters }) {
    ...
    return (
        <div>
        <h4 className="mt-4 text-center mb-0" style={{backgroundColor: '#2c5949', color: '#FFF', padding: '20px', borderTopLeftRadius: '11px', borderTopRightRadius: '11px', fontSize: '20px'}}>Filter by Categories</h4>
